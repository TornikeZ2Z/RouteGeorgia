          ...
          <div className="flex gap-1">
            {[1, 2, 3, 4, 5].map((value) => (
              <label key={value} className="cursor-pointer">
                ...
                />
                <span className="inline-flex size-10 items-center justify-center rounded-lg border border-ink-300 text-sm peer-checked:border-ink-900 peer-checked:bg-ink-900 peer-checked:text-white">
                  {value}
                </span>
              </label>
            ))}
