...
const D = {
  ...
  "cr.contactL": { ka: "ტელეფონი ან ელფოსტა", en: "Phone or email" },
  "cr.contactH": { ka: "არასავალდებულო.", en: "Optional." },
  ...
  "cr.reasonL": { ka: "რატომ არის ეს მნიშვნელოვანი?", en: "Why does this matter?" },
  "cr.reasonH": { ka: "არასავალდებულო, მაგრამ სწორედ ეს გვეხმარება პრიორიტეტის განსაზღვრაში.", en: "Optional, but this is what lets us judge priority." },
  "cr.areaL": { ka: "რომელ ნაწილს ეხება?", en: "Which part of the product?" },
  "cr.urgencyL": { ka: "რამდენად სასწრაფოა?", en: "How urgent?" },
