...
/**
 * Georgian. Intentionally partial — untranslated keys fall back to English and
...
export const ka: Partial<Dictionary> = {
  ...
  "home.heroSubtitle": "ფიქსირებული ფასი მთელ ავტომობილზე. კონკრეტული მძღოლი და მანქანა, შეთანხმებული მგზავრობამდე.",
